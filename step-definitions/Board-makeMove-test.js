...
module.exports = function () {
  ...
  await this.Given(/^board playInProgress property is initially false upon invalid move$/, function () {
    expect(fakeGame.board.playInProgress).to.be.false;
  });

  await this.When(/^there are no free positions available in a column for more game pieces$/, async function () {
  ...
  await this.Then(/^board makeMove method should return false$/, async function () {
